...
namespace Petcu_Cosmina_Lab4
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\Cosmina\OneDrive\Desktop\Sisteme Big Data\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=754,NumberOfIterations=4,MinimumExampleCountPerLeaf=20,LearningRate=0.6262432471882193,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.17277127054584893,FeatureFraction=0.99999999,L1Regularization=1.9692622877711254E-09,L2Regularization=0.5506039261171051},MaximumBinCountPerFeature=196}));
